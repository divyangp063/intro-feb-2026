...
- Exceeds normal "software testing" - which is "does it meet the business and technical requirements" - all that, plus testing our implementation, our thinking, finding concepts (duplication), etc.
...
```
    ...
    3. No Duplication - We've identified concepts
    4. Fewest Elements - Less is better
```

The Guardrail:
    - Set a time limit on getting the test to pass
        - Check out Ulysses Principle
    - GET THE TEST TO PASS
        - Write ugly, nasty code if you have to
        - Nobody will see it. Use stupid variable names
        - Hard code things that shouldn't be
...
Test Driven Development
    - A self-discipline we impose on ourselves to write better code

Assembly - That you are testing
"System Under Test" ("SUT")


- You write some code that can be discovered automatically by a test runner, and the test will execute that code
- (Low bar) As long as that code doesn't blow up (Throw an exception) it counts as a passing test

Test environment:
- Visual Studio - we can say run the tests, let me know how we are doing
- We can also run these in our CI Pipeline


Continuous Integration:

- Your integrity as a team of development
- If code comes out the other end of this pipeline, we are doing everything we can to say "This is good code"
- That does not mean you are saying "It is ready to be released" but it *could* be
...
- Coupling - "The strength of relationships between code modules"
    ...
    - "Code smell": "Inappropriate Intimacy" - You, as a customer, shouldn't know how I am writing the code
